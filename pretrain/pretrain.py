...
from config import get_model_identifiers_from_yaml
...
def main(cfg):
    ...
    torch_format_dataset = TextDatasetQA(cfg.data_path, tokenizer=tokenizer, model_family = cfg.model_family, max_length=cfg.max_length, split=cfg.split, data_type=cfg.data_type)
